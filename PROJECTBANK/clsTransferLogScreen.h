...
private:
	...
	static void PrintTransferLogRecordLine(clsBankClient::stTransferRegisterRecord TransferLogRecord)
	{
		...
		cout << "| " << setw(10) << left << TransferLogRecord.Balance1;
		cout << "| " << setw(10) << left << TransferLogRecord.Balance2;
...
public:
	...
	{
		vector <clsBankClient::stTransferRegisterRecord> vTransferLogRecord = clsBankClient::GetTransferRegisterList();
